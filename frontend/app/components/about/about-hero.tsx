        ...
        <section className="relative w-full min-h-screen flex flex-col items-center justify-center overflow-hidden pt-32 pb-20 z-10">
            ...
            <div className="container relative z-10 mx-auto px-6 text-center max-w-5xl">
                ...
                >
                    ...
                    <h1 className="text-5xl md:text-7xl lg:text-[6rem] font-black tracking-tighter text-[#FFFFFF] leading-[0.9] mb-8">
                        Redefiniendo el<br />
                        <span className="bg-gradient-to-r from-[#0C4C78] via-[#0255D1] to-[#47b6ff] bg-clip-text text-transparent pb-2 lg:pb-4 inline-block">Cristal Templado</span>
                    </h1>
