...
const principles = [
  ...
  },
  {
    ...
    desc: "Calidad respaldada por protocolos de control en planta y cumplimiento de normativas de seguridad vigentes. Encontramos el balance perfecto entre desempeño superior y competitividad en costos.",
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
