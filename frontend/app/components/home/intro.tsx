    ...
    return (
        <section className="w-full py-20 px-6 bg-white">
            <div className="max-w-4xl mx-auto text-center space-y-6">
                <h2 className="text-3xl md:text-5xl font-bold tracking-tight text-[#373435]">Expertos en Cristal Templado</h2>
                <p className="text-xl text-[#373435]/70 leading-relaxed">
