...
export function ContactCTA() {
  return (
    <section className="w-full py-20 px-6 relative overflow-hidden bg-white">
      ...
      <div className="max-w-5xl mx-auto relative z-10 text-center rounded-3xl bg-gradient-to-br from-[#0255D1] to-[#0C4C78] text-white p-8 shadow-[0_16px_64px_rgba(2,85,209,0.30)]">
