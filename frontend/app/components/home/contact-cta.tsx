...
export function ContactCTA() {
  return (
    <section className="w-full py-24 px-6 relative flex items-center justify-center -mt-8">
      <div className="w-full max-w-6xl relative z-10 rounded-[3rem] overflow-hidden bg-[#0C4C78] py-24 px-8 text-center shadow-[0_30px_100px_rgba(12,76,120,0.3)] border border-white/10 mt-16">
        ...
        >
          <span className="inline-block py-1.5 px-4 rounded-full bg-white/10 backdrop-blur-md border border-white/20 text-white text-sm font-semibold tracking-widest uppercase mb-8 shadow-xl">
            Líderes en Vidrio Templado
          </span>
          <h2 className="text-4xl md:text-5xl lg:text-7xl font-black text-white mb-8 leading-tight drop-shadow-2xl">
            ¿Listo para <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#8fd7ff] to-white pb-2 inline-block">innovar?</span>
          </h2>
          <p className="text-xl md:text-2xl text-[#8fd7ff]/80 font-medium mb-12 max-w-2xl px-4 text-balance">
            Trae tu proyecto a GlassPro y experimenta el nivel de servicio y calidad que nos caracteriza a nivel nacional.
          </p>
