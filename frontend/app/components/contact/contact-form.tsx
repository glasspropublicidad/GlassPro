      ...
      <AnimatePresence mode="wait">
        {actionData?.success ? (
          ...
          >
            ...
            >
              {/* ── Herraje callout ───────────────────────────── */}
              <div className="flex items-center gap-2.5 px-4 py-3 rounded-xl bg-[#0255D1]/[0.06] border border-[#0255D1]/10">
                <span className="text-[#0255D1]">
                ...
                <span className="text-sm font-bold text-[#0255D1]/90">
                  También ofrecemos venta de herraje para cristal
                </span>
              </div>
